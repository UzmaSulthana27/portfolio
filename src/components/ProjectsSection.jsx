...
const projects = [
  ...
  {
    id: 1,
    title: "Detection of phising website",
    Description: "A detection of phising website using ml ",
    image: "public/Projects/phising.png",
    tags: ["python", "flask"],
    demoUrl: "#",
    githubUrl: "#",
  },
  ...
  return (
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        <h2 className="text-3xl md:texgt-4xl font-bold mb-4 text-center">
